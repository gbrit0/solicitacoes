                        ...
                        for num, instance in enumerate(instances):
                            ...
                            insert = (
                                f"BEGIN TRY"
                                    ...
                                    f"COMMIT; -- Confirma a transação se tudo der certo"
                                f"END TRY"
                                f"BEGIN CATCH"
                                    f"ROLLBACK; -- Desfaz a transação em caso de erro"
                                    
                                    f"-- Lança o erro para que a conexão ou o log possam capturá-lo"
                                    f"THROW;"
                                f"END CATCH;"
                            )
                            # f"INSERT INTO SC1010 "
